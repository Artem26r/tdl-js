...
(function () {
    ...
    var createUserOption = function (user) {
        if (userSelect) {
    ...
    var printTodo = function (_a) {
        var userId = _a.userId, id = _a.id, title = _a.title, completed = _a.completed;
    ...
    var removeTodo = function (todoId) {
        var _a, _b;
        if (todoList) {
            todos = todos.filter(function (todo) { return todoId !== todoId; });
    ...
    //Async logic
    var getAllTodos = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    var createTodo = function (todo) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var toggleTodoComplete = function (todoId, completed) { return __awaiter(_this, void 0, void 0, function () {
